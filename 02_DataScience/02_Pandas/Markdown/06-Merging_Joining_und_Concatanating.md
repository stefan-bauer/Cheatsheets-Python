...
Die `merge` Funktion erlaubt es uns ähnlich wie in SQL Data Frames zusammenzuführen. Zum Beispiel:
...
Oder an einem etwas komplizierteren Beispiel veranschaulicht:
...
```python
pd.merge(links, rechts, how='outer', on=['key1', 'key2'])
```
